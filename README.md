...
- **Free evaluation sample** on GitHub (`3d`) · **11 timeframes** on [getdata.finance](https://getdata.finance/datasets/usdjpy) · **3,015** `3d` rows in the full archive
- Built for **backtesting**, **algorithmic trading** and **quantitative finance** workflows
- **Weekly refresh** — [getdata.finance](https://getdata.finance) every **Saturday, 8am UTC+0**; GitHub `3d` sample updated in sync

> **Sample on GitHub** · `USDJPY_3d.csv` (244 rows, `2024-09-08` -> `2026-09-07`, 27.93 KB). **Full archive on [getdata.finance](https://getdata.finance/datasets/usdjpy)** — **3,015** `3d` rows (full `1m`: 9,184,987), **11 timeframes**, `2001-11-26` -> `2026-09-07`.
...
| 3d rows | 244 | **3,015** |
| Size | 27.93 KB | full ZIP on [getdata.finance](https://getdata.finance/datasets/usdjpy) |
...
| 2026-09-04T00:00:00+00:00 | 155.644 | 156.742 | 155.289 | 156.205 | 393199 |
| 2026-09-07T00:00:00+00:00 | 156.205 | 156.256 | 152.89 | 153.56 | 745685 |
...
The complete **USDJPY** archive on **[getdata.finance](https://getdata.finance/datasets/usdjpy)** includes **11 OHLCV timeframes** (1m · 3m · 5m · 15m · 30m · 1H · 4H · 12H · 1D · 3D · 1W) — **3,015** rows at `3d`, plus all other timeframes in the same ZIP.
